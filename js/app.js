...
(() => {
  ...
  const translations = {
    en: {
      ...
      'info.title': 'About us',
      'info.desc': 'This app is to be used with the board game Climate Journey. The board game was design and developed by researchers at the University of Applied Sciences St. Pölten with Austrian schools with the goal to reflect on the topic of sustainable mobility.',
    ...
    de: {
      ...
      'info.title': 'Über uns',
      'info.desc': 'Diese App ist zur Verwendung mit dem Brettspiel Climate Journey vorgesehen. Das Brettspiel wurde von Forscher:innen der Hochschule für Angewandte Wissenschaften St. Pölten in Zusammenarbeit mit österreichischen Schulen entworfen und entwickelt, mit dem Ziel, zum Nachdenken über das Thema nachhaltige Mobilität anzuregen.',
